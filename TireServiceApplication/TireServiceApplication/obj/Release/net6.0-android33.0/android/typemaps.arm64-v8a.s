...
map_modules:
	...
	.byte	0x3b, 0xa1, 0xe, 0x47, 0x86, 0x7d, 0x5f, 0x4d, 0x98, 0xa6, 0x8e, 0xb4, 0x36, 0x51, 0xcd, 0xfe	// module_uuid: 470ea13b-7d86-4d5f-98a6-8eb43651cdfe
	...
	.byte	0x77, 0x77, 0xff, 0xcb, 0x1d, 0x4a, 0x5d, 0x46, 0xa0, 0x4c, 0x37, 0x51, 0xdc, 0x3d, 0x5a, 0x51	// module_uuid: cbff7777-4a1d-465d-a04c-3751dc3d5a51
	...
	.byte	0xd8, 0x6d, 0x15, 0xb6, 0x4c, 0xff, 0xf1, 0x4f, 0xa4, 0xcf, 0x67, 0xb3, 0xf3, 0x58, 0xfb, 0xee	// module_uuid: b6156dd8-ff4c-4ff1-a4cf-67b3f358fbee
	.word	0x2	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module30_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.30	// assembly_name: TireServiceApplication
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
...
map_java:
	...
	.ascii	"crc64044dacee5f4d8105/MainActivity"	// java_name
	.zero	69	// byteCount == 34; fixedWidth == 103; returned size == 103
	.zero	1

	.word	0x1e	// module_index
	.word	0x200001d	// type_token_id
	.ascii	"crc64044dacee5f4d8105/MainApplication"	// java_name
	.zero	66	// byteCount == 37; fixedWidth == 103; returned size == 103
	.zero	1
